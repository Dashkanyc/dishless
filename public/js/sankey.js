 function SankeyLayout() {
  ...
  function init() {
    ...
    // Make a post call to server for sankey diagram
     makepostcall('/getsankeyaggregates',{'start':0 , 'end': 2487025157},updatesankeymodel);
  }
  ...
  var sankeycolors = ["#9d75c2","#a1e194","#f6bcd5","#681313","#3483ba","#fea19f","#d93c3c","#a6dce6","#b5cbe9","#40a840","#cbcbcb","#a1e194","#556171","#96665c","#40a840","yellow"];

  var mySavedModel = {};

  function updatesankeymodel(responsetxt){
    mySavedModel = JSON.parse(responsetxt);
    //mySavedModel = dummymodel;
    load();
  }

  var dummymodel = { "class": "go.GraphLinksModel",
                     "nodeDataArray": [
