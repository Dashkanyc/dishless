function timelinedivinit() {
console.log("********************* timelinedivinit");

    var $ = go.GraphObject.make;  // for conciseness in defining templates

    timelineDiagram = $(go.Diagram, "timelinediv",  // create a Diagram for the DIV HTML element
                  {
    ...
    timelineDiagram.nodeTemplateMap.add("Line",
      $(go.Node, "Graduated",
        {
    ...
    timelineDiagram.model = $(go.TreeModel, { nodeDataArray: data });
  }

  function timelineDays() {
    var timeline = timelineDiagram.model.findNodeDataForKey("timeline");
